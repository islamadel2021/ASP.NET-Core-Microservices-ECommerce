...
namespace Matgr.EmailsAPI.Services
{
    public class RabbitMQPaymentConsumer : BackgroundService
    {
        ...
        public RabbitMQPaymentConsumer(EmailRepository emailRepository)
        {
            ...
            _channel.QueueDeclare(_paymentEmailQueueName, false, false, false);
            //_channel.QueueBind(queueName, _fanoutExchangeName, "");
            _channel.QueueBind(_paymentEmailQueueName, _directExchangeName, "PaymentEmail");
        }
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            _channel.BasicConsume(_paymentEmailQueueName, false, consumer);
