...
using Matgr.ShoppingCartAPI.Messages;
using Matgr.ShoppingCartAPI.Models.Dto;
using Matgr.ShoppingCartAPI.Models.Dtos;
using Matgr.ShoppingCartAPI.RabbitMQSender;
using Matgr.ShoppingCartAPI.Repository;
    ...
    public class CartController : ControllerBase
    {
        ...
        public async Task<object> Checkout(CheckoutMessageDto messageDto)
        {
            try
            {
                ...
                //await _messageBus.PublishMessage(messageDto, "checkoutmessagetopic");
                //await _messageBus.PublishMessage(messageDto, "checkoutmessagequeue");
                //RabbitMQ
