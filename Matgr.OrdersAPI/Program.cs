...
using Matgr.OrdersAPI.Extensions;
using Matgr.OrdersAPI.OrdersAPIData;
using Matgr.OrdersAPI.RabbitMQSender;
using Matgr.OrdersAPI.Repository;
using Matgr.OrdersAPI.Services;
...
builder.Services.AddAuthentication("Bearer")
    ...
    {
        opt.Authority = "https://localhost:7283/";
...
{
    c.SwaggerDoc("v1", new OpenApiInfo() { Title = "Matgr.OrdersAPI" });
